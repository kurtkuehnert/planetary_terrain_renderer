...
pub(crate) const PREPASS_SHADER: &str = "embedded://bevy_terrain/shaders/entry_points/prepass.wgsl";
pub const DEFAULT_VERTEX_SHADER: &str = "embedded://bevy_terrain/shaders/entry_points/vertex.wgsl";
pub const DEFAULT_FRAGMENT_SHADER: &str =
    "embedded://bevy_terrain/shaders/entry_points/fragment.wgsl";
pub(crate) const PICKING_SHADER: &str = "embedded://bevy_terrain/shaders/entry_points/picking.wgsl";
pub(crate) const MIP_SHADER: &str = "embedded://bevy_terrain/shaders/entry_points/mipmap.wgsl";
pub(crate) const DEPTH_COPY_SHADER: &str =
    "embedded://bevy_terrain/shaders/entry_points/depth_copy.wgsl";
...
pub(crate) fn load_terrain_shaders(app: &mut App, attachments: &[AttachmentLabel]) {
    ...
    embedded_asset!(app, "entry_points/prepass.wgsl");
    embedded_asset!(app, "entry_points/vertex.wgsl");
    embedded_asset!(app, "entry_points/fragment.wgsl");
    embedded_asset!(app, "entry_points/mipmap.wgsl");
    embedded_asset!(app, "entry_points/depth_copy.wgsl");
    embedded_asset!(app, "entry_points/picking.wgsl");
    ...
    InternalShaders::load(
        ...
        &[
            ...
            "embedded://bevy_terrain/shaders/entry_points/vertex.wgsl",
            "embedded://bevy_terrain/shaders/entry_points/fragment.wgsl",
        ],
    );
}
